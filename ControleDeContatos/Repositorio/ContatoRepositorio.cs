...
namespace ControleDeContatos.Repositorio
{
    public class ContatoRepositorio : IContatoRepositorio
    {
        ...
        public ContatoModel Atualizar(ContatoModel contato)
        {
            ...
            if (contatoDB == null) throw new Exception("Houve um erro na atualização do registro!");

            contatoDB.Nome = contato.Nome;
            contatoDB.Matricula = contato.Matricula;
            contatoDB.Entrada = contato.Entrada;
            contatoDB.Saida = contato.Saida;
        ...
        public bool Apagar(int id)
        {
            ...
            if (contatoDB == null) throw new Exception("Houve um erro na deleção do registro!");
